  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/manager" element={<PrivateRoute element={<ManagerLayout />} roles={['Manager']} />}>
          <Route path="dashboard" element={<Dashboard />} />
          <Route path="manage-assets" element={<AssetManagement />} />
          <Route path="pending-requests" element={<PendingRequestsTable />} />
          <Route path="allocate-asset" element={<AllocationForm onAllocationSuccess={handleAllocationSuccess} />} />
          <Route path="asset-allocated" element={<AssetAllocationTable allocations={allocations} />} />
          <Route path="completed-requests" element={<CompletedRequestsTable requests={[]/*fetch data*/} />} />
        </Route>
        <Route path="/employee" element={<PrivateRoute element={<EmployeeLayout />} roles={['Employee']} />}>
